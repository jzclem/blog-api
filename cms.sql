...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '123', '黄小米', '女', '15863008280', 'nn880328@126.com', 'https://api.raner.top/images/avatar/default.jpg');
INSERT INTO `admin` VALUES (2, 'moz', '123', '孙红雷', '男', '15863008280', 'nn880328@126.com', 'https://api.raner.top/images/avatar/default.jpg');
INSERT INTO `admin` VALUES (3, 'silky', '123', '鹿晗', '男', '15863008280', 'nn880328@126.com', 'https://api.raner.top/images/avatar/default.jpg');
...
CREATE TABLE `article_tag`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `article_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '博客ID',
...
INSERT INTO `menu` VALUES (2, '信息面板', 1, '', '2000', '137');
INSERT INTO `menu` VALUES (3, '文章管理', 1, '', '3000', 'document');
INSERT INTO `menu` VALUES (4, '分类管理', 1, '/category/list', '4000', 'data-analysis');
INSERT INTO `menu` VALUES (5, '标签管理', 1, '/tag/list', '5000', 'collection-tag');
INSERT INTO `menu` VALUES (6, '用户管理', 1, '', '6000', 'user');
INSERT INTO `menu` VALUES (7, '管理员管理', 1, '', '7000', 'set-up');
INSERT INTO `menu` VALUES (8, '权限管理', 1, '', '8000', 'connection');
INSERT INTO `menu` VALUES (9, '账户设置', 1, '/admin/info', '9000', 'setting');
INSERT INTO `menu` VALUES (10, '发布文章', 3, '/article/release', '3001', NULL);
INSERT INTO `menu` VALUES (11, '文章列表', 3, '/article/list', '3002', NULL);
INSERT INTO `menu` VALUES (12, '分类列表', 4, '/category/list', '4001', NULL);
INSERT INTO `menu` VALUES (13, '用户列表', 6, '/user/list', '6001', NULL);
...
CREATE TABLE `tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '账户' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tag
-- ----------------------------
INSERT INTO `tag` VALUES (1, 'Web前端1');
